...
class Game:
    def __init__(self):  #
        self.tk = Tk()
        self.tk.title("Mr.Stick for the Exit")
...
class StickFigureSprite(Sprite):
    def __init__(self, game):
        ...
        self.image = game.canvas.create_image(0, 450, image=self.images_right[0], anchor='nw')
        self.x = 0
        self.y = 0
...
door = DoorSprite(g, PhotoImage(file="门1.gif"), 45, 30, 40, 35)
